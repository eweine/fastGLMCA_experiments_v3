...
time_vec <- c(time_vec, seq(0, 54633.786 / 60, length.out = length(glmpca_sgd$lik)))
...
Below is a table of final log-likelihoods. 

```{r}
algorithm <- c(
  "glmpca-sgd", "fastGLMPCA-1core", "fastGLMPCA-28core"
)

final_loglik <- c(
  glmpca_sgd$lik[350],
  fastGLMPCA_1core$progress$loglik[10],
  fastGLMPCA_28core$progress$loglik[11]
)
