...
final_loglik <- c(
  glmpca_fisher$lik[25],
  glmpca_sgd$lik[1100],
  fastGLMPCA_1core$progress$loglik[26],
  fastGLMPCA_28core$progress$loglik[23]
)
